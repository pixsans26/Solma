    ...
    return (
        <div className="absolute top-0 left-0 w-full z-[100] flex items-center justify-between p-[24px_16px_20px_16px] bg-gradient-to-b from-[rgba(0,0,0,0.7)] via-[rgba(0,0,0,0.3)] to-transparent">
            ...
            <div className="flex items-center gap-4">
                <FiSearch className="text-white text-[20px] opacity-[0.85] cursor-pointer" />
                <FiBell className="text-white text-[20px] opacity-[0.85] cursor-pointer" />
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-ott-grad-start to-ott-grad-end border-2 border-white/10" />
            </div>
        </div>
    );
}
